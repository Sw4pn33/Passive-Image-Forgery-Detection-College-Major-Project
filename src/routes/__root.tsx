...
import { HistorySheet } from "@/components/detection/HistorySheet";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ForensicVision — Passive Image Forgery Detection" },
      {
        name: "description",
        content:
          "Hybrid DCNN + SLIC + SIFT pipeline for detecting copy-move and splicing forgeries in images. Trained on CASIA v1.0.",
      },
      { name: "author", content: "ForensicVision" },
      { property: "og:title", content: "ForensicVision — Passive Image Forgery Detection" },
      {
        property: "og:description",
        content:
          "Hybrid deep-learning and classical computer-vision pipeline for image forgery detection.",
      },
